module github.com/joeycumines/ai-concurrency-shaper
...
require (
	...
	github.com/joeycumines/gopoet-protogen v0.2.0 // indirect
	github.com/joeycumines/protoc-gen-go-copy v0.2.0 // indirect
	github.com/joeycumines/sesame v0.1.1 // indirect
